...
class SequenceProcessor:
    ...
    def idx_to_item(self, idx: int) -> str | None:
    ...
    def decode_recommendations(self, indices: list[int]) -> list[str | None]:
    ...
    @classmethod
    def from_vocabulary(cls, vocabulary: dict[str, int], max_length: int = 50) -> SequenceProcessor:
